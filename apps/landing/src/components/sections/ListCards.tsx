          ...
          >
            {slides.map((slide, idx) => (
              <div
                ...
                className='relative flex h-[420px] shrink-0 snap-start basis-[70%] items-end overflow-hidden border border-white/10 bg-gradient-to-b from-white/10 to-white/5 shadow-[0_30px_120px_rgba(0,0,0,0.5)] md:h-[520px]'
              >
                <img
                  src={slide.image}
                  alt={slide.alt}
