  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex z-[999999]",
          side === "left"
      ...
      >
        <div
          ...
          className='bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-[calc(100% - 20px)] w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm'
        >
          {children}
        </div>
      </div>
